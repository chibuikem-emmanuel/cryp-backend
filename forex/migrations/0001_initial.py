    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.CharField(choices=[('VIP_SIGN_UP', 'VIP Sign Up'), ('POOL_TRADING', 'Pool Trading')], default='VIP_SIGN_UP', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coin', models.CharField(choices=[('BTC', 'Bitcoin'), ('ETH', 'Ethereum'), ('USDT', 'Tether USD'), ('USDC', 'USD Coin')], max_length=10)),
                ('network', models.CharField(default='Mainnet', max_length=50)),
